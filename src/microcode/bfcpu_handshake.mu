...
[microcode] {
  ...
  WAIT_EXT:1:xxxx       -> LD_D
  WAIT_EXT:2:xxxx       -> INC, RS0
  WAIT_EXT:3:xxxx       -> INC, RS0
  WAIT_EXT:4:xxxx       -> INC, RS0
  WAIT_EXT:5:xxxx       -> LD_FB
  WAIT_EXT:6:xxx0       -> CR
  WAIT_EXT:6:xxx1       -> EN_IN, EN_OUT
  WAIT_EXT:7:xxx1       -> INC, RS2, CR    
