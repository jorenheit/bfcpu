\chapter{Flashback} \label{sec:appendix:flashback}
\newpage
...
\begin{figure}[H]
  ...
  \caption{The (segmented) control unit starts to take shape. The bottom-middle section contains the logic for sequentially fetching the three parts of the control word from different sections in the MC EEPROM chip.}
...
\begin{figure}[H]
  ...
  \caption{The (segmented) control unit starts to take shape even more. A display for showing the current instruction was added (7-segment display, bottom left).}
