...
\item K\_REC - K Received and Reset - connected to the CU.
\end{itemize}

\subsubsection*{Outputs}
\begin{itemize}
\item SET\_K: Set the acknowledge-flag.
\end{itemize}
...
\item LD\_IP - Load IP
\item CR - Cycle Reset
\item CLR\_K - Clear the K register
\item K\_REC - Assert the K-Received/Reset signal onto the IO system
