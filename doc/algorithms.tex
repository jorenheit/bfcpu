...
\begin{lstlisting}
  # Prepare copies, return values and flags
  {div <- 0}
  {mod <- 0}
  {zeroFlag <- 1}  
  {loopFlag <- 1}
  ...
  # Special case 1: the denominator is 0
  # --> return 255 and skip the rest
  {yCopy}
  [
    {zeroFlag <- 0}
    {yCopy <- 0}
