\chapter{Bill of Materials} \label{sec:bom}
The following chapter lists all components required to build the Synapse-191 computer, including
...
\begin{table}[H]
  ...
  \begin{tabular}{r|c|l}
    ...
    74LS161                  & 2 & 4-Bit Counter  \\
    74LS173                  & 9 & 4-Bit Register  \\
    74LS193                  & 14 & 4-Bit U/D Counter  \\
    74LS245                  & 10 & 8-Bit Bus Transceiver  \\
    74HC595                  & 1 & 8-Bit Shift Register  \\
    MC14078B                 & 2 & 8-Input NOR  \\
    NE555                    & 4 & 555-Timer \\
    AT28C64B                 & 4 & 64-Kbit ($8\text{K}\times8$) EEPROM  \\
    AS6C4008                 & 2 & $512\text{K}\times8$ SRAM  \\
    ICM7226B                 & 1 & Frequency Timer  \\
  \end{tabular}
  \caption{ICs used in the project.}
  \label{tab:parts}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabular}{r|c|l}
    ...
    HD44780-Compatible LCD   & 1 & $20\times4$ characters  \\
  \end{tabular}
  \caption{Other parts used in the project.}
  \label{tab:otherparts}
\end{table}
